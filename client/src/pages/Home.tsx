    ...
    <>
            ...
            <div className="f-grid fu">
              <div className="f-card">
                ...
                <div className="f-desc">
                  High stress, a racing mind, trouble feeling settled. The grounding formula.
                </div>
              ...
              <div className="f-card">
                ...
                <div className="f-desc">
                  Overheating, afternoon slumps, a need to reset. The cooling formula.
                </div>
                <div className="f-mech">
              ...
              <div className="f-card">
                ...
                <div className="f-desc">
                  Flat energy, low motivation, need to perform. The lift formula.
                </div>
                <div className="f-mech">
              ...
              <div className="f-card">
                ...
                <div className="f-desc">
                  Scattered focus, too many tabs open, cognitive demand. The focus formula.
                </div>
                <div className="f-mech">
      ...
      <section id="shop" aria-labelledby="shop-h">
        <div className="shop-sec">
          <div className="shop-i">
            <p className="eye">Sourced, Not Just Sold</p>
            <h2 className="shop-title" id="shop-h">
              Our formulas are the core. Everything else, we go find.
            </h2>
            <p className="shop-sub">
              We do the science — the compound research, the mechanism-first
              formulation, the protocol design. For the carriers, skin, hair,
              and fragrance your ritual also needs — for both body and space —
              we search for products carrying compounds and essences we've
              already validated, cited the same way we cite everything else.
              Our own formulas come first; this is what supports them.
            </p>
            ...
            <div className="shop-note">
              ...
              translates the science, and designs every formula in-house.
              For carriers, skin, hair, and fragrance sourced from outside
              partners, we curate — we don't formulate, and we don't make
              efficacy claims on their behalf. Compliance and safety for
              those products sit with the brands that make them.
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="perimenopause" aria-labelledby="peri-h">
        ...
        >
          <div className="fu">
            ...
            <p className="sec-body">
              Hormonal fluctuation changes how your nervous system runs, day
              to day. We designed three formulas around that transition —
              each working through a specific, published mechanism.
            </p>
          </div>
          <div className="peri-grid fu">
            <div className="peri-card">
              <div className="peri-sym">Thermal Comfort</div>
              <div className="peri-f">Nexus Thermal Reset</div>
              <div className="peri-d">
                TRPM8 channel activation for a cooling sensory response and a lift in alertness.
              </div>
              <div className="peri-p">Best for: moments your temperature feels unpredictable</div>
            </div>
            <div className="peri-card">
              <div className="peri-sym">Nervous System</div>
              <div className="peri-f">Nexus Baseline</div>
              <div className="peri-d">
                GABAergic modulation to support a grounded, settled state.
              </div>
              <div className="peri-p">Best for: moments that feel wired or restless</div>
            </div>
            <div className="peri-card">
              <div className="peri-sym">Cognitive Support</div>
              <div className="peri-f">Acuity Strike</div>
              <div className="peri-d">
                Dopaminergic pathways to support directed attention and focus.
              </div>
              <div className="peri-p">Best for: moments concentration feels harder to hold</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="waitlist" aria-labelledby="wl-h">
        <div className="wl-sec fu">
          ...
          <p className="wl-body">
            Curated essentials are available now. Our own formula protocols
            launch soon. Join the list to get 15% off your first formula order.
          </p>
      ...
      <footer role="contentinfo">
        <div className="ft-i">
          <div className="ft-top">
            ...
            <div>
              <div className="ft-ct">Follow</div>
              <ul className="ft-links">
                <li><a href="https://www.instagram.com/sana_essencia/" target="_blank" rel="noopener noreferrer">Instagram</a></li>
                <li><a href="https://www.facebook.com/profile.php?id=61591903798780" target="_blank" rel="noopener noreferrer">Facebook</a></li>
                <li><a href="https://www.youtube.com/@PatriciaCruz-d4s" target="_blank" rel="noopener noreferrer">YouTube</a></li>
                <li><a href="https://www.linkedin.com/in/patricia-cruz-7a3a90412/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
              </ul>
            </div>
          </div>
